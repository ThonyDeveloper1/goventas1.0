  ...
  <div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      <div>
        ...
        <p class="text-gray-500 text-sm mt-0.5">{{ store.pagination.total }} supervisiones en total</p>
      </div>
      <button
        v-if="auth.isAdmin"
    ...
    <div v-else class="space-y-3">
      ...
      >
        <div class="flex items-start gap-4">
          <!-- Status indicator -->
          <div :class="['w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0', estadoBadge(sup.estado).bg]">
            <span :class="['w-2.5 h-2.5 rounded-full', estadoBadge(sup.estado).dot]" />
          </div>
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <span :class="['px-2 py-0.5 rounded-full text-xs font-medium', estadoBadge(sup.estado).bg, estadoBadge(sup.estado).text]">
                {{ estadoBadge(sup.estado).label }}
              </span>
            </div>
    ...
    <Teleport to="body">
      <Transition name="fade">
        <div v-if="showAssignModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40" @click.self="showAssignModal = false">
